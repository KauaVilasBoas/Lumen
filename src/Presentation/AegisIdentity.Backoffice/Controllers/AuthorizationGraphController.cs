...
public sealed class AuthorizationGraphController : Controller
{
    ...
    public AuthorizationGraphController(IUserPermissionService permissionService)
    {
    ...
    private static object BuildGraph()
    {
        var permissions = new Dictionary<string, object>
        {
            ...
            ["p_authgraph"]   = new { code = PermissionCodes.AuthorizationGraph.View, name = "View authorization graph", method = "GET", group = PermissionGroups.Authorization, orphan = false },
        ...
        var profiles = new Dictionary<string, object>
        {
            ...
            ["pr_secaudit"] = new { name = "Security Auditor", color = "#4c8dff", isSystem = false, permissions = new[] { "p_prof_index", "p_prof_get", "p_perm_index", "p_up_index", "p_usr_index", "p_usr_get", "p_authgraph" } },
