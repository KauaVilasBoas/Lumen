...
public sealed class UserUpdateEndpointTests
{
    ...
    public async Task Put_WithUsersUpdatePermission_NonExistentId_Returns404()
    {
        ...
        await AuthorizationSeeder.SeedUserWithPermissionAsync(db, Guid.Parse(requestingUserId), "Users.Update");
    ...
    public async Task Put_ChangeUsername_Returns200WithEmailChangedFalse()
    {
        ...
        var targetUserId = Guid.Parse("97000000-0000-0000-0000-000000000004");
    ...
    {
        const string requestingUserId = "97000000-0000-0000-0000-000000000005";
        var targetUserId = Guid.Parse("97000000-0000-0000-0000-000000000006");
    ...
    {
        const string requestingUserId = "97000000-0000-0000-0000-000000000007";
        var targetUserId = Guid.Parse("97000000-0000-0000-0000-000000000008");
    ...
    {
        const string requestingUserId = "97000000-0000-0000-0000-000000000009";
        var targetUserId = Guid.Parse("97000000-0000-0000-0000-000000000010");
    ...
    {
        const string requestingUserId = "97000000-0000-0000-0000-000000000011";
        var targetUserId = Guid.Parse("97000000-0000-0000-0000-000000000012");
