...
internal sealed class EmailTemplateRenderer : IEmailTemplateRenderer
{
    ...
    // Must match the assembly name + folder path of the embedded resources
    private const string ResourceNamespace = "Lumen.Identity.Infrastructure.Notifications.Templates.Email";
