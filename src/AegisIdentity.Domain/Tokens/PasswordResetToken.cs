...
/// <summary>
/// A single-use token for resetting an account password.
///
/// Design decisions:
...
public sealed class PasswordResetToken
{
    ...
    /// <summary>Set when the token is consumed to perform a password reset. Null for unused tokens.</summary>
    public DateTime? UsedAt { get; private set; }

    // ─── Factory ──────────────────────────────────────────────────────────────

    /// <summary>
    /// Creates a new, unused password reset token.
    /// </summary>
    ...
    /// Always evaluate this before accepting a password reset request.
    /// </summary>
