...
/// <summary>
/// BSON class map for <see cref="EmailConfirmationToken"/>.
///
...
/// </summary>
public static class EmailConfirmationTokenClassMap
{
    ...
    public static void RegisterOnce()
    {
        ...
        lock (RegisterLock)
        {
            ...
            BsonClassMap.RegisterClassMap<EmailConfirmationToken>(map =>
            {
                map.AutoMap();
                ...
                map.MapMember(t => t.UsedAt).SetElementName("usedAt");
            });
